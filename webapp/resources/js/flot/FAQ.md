...
#### How much dataObj can Flot cope with? ####
...
#### Flot isn't working when I'm using JSON dataObj as source! ####

Actually, Flot loves JSON dataObj, you just got the format wrong.
